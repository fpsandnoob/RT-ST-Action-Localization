...
if __name__ == '__main__':
    c = UCF24Detection('/mnt/data/Action/data/ucf24/ucf24/', 'test', BaseTransform(300, (104, 117, 123)), AnnotationTransform(),
                       input_type='rgb', full_test=False)
    val_data_loader = data.DataLoader(c, 1, num_workers=1,
