...
def main():
    ...
    if args.input_type == 'fastOF':
        ...
        ckpt_path = "/mnt/data/Action/data/ucf24/ucf24/" \
                    "cache/CONV-SSD-ucf24-rgb-bs-40-lr-00100/ssd300_ucf24_60000.pth"
        print('Loading base network... from {}'.format(ckpt_path))
        vgg_weights = torch.load(ckpt_path)
