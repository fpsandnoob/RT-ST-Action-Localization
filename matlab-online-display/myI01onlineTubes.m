...
close all
data_root = '/mnt/data/Action/data/ucf24/';
save_root = '/mnt/data/Action/data/ucf24/';
iteration_num_rgb = [25000]; % you can also evaluate on multiple iertations
iteration_num_flow = [250000]; % you can also evaluate on multiple iertations
